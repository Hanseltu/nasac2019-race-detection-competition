; ModuleID = 'svp_simple_019_001-opt-opt.bc'
source_filename = "./svp_simple_019_001.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@svp_simple_019_001_global_condition1 = dso_local global i32 1, align 4
@svp_simple_019_001_global_condiiton2 = dso_local global i32 1, align 4
@svp_simple_019_001_global_condition3 = dso_local global i32 1, align 4
@svp_simple_019_001_global_para1 = common dso_local global i32 0, align 4
@svp_simple_019_001_global_para2 = common dso_local global i32 0, align 4
@svp_simple_019_001_global_para3 = common dso_local global i32 0, align 4
@svp_simple_019_001_global_var1 = common dso_local global i32 0, align 4
@svp_simple_019_001_global_var2 = common dso_local global i32 0, align 4

; Function Attrs: nounwind uwtable
define dso_local void @svp_simple_019_001_main() #0 !dbg !7 {
...
24:                                               ; preds = %22, %19, %15
  call void (...) @idlerun() #3, !dbg !43
  call void @disable_isr(i32 1) #3, !dbg !44
...
32:                                               ; preds = %30, %27, %24
  call void @enable_isr(i32 1) #3, !dbg !53
  call void (...) @idlerun() #3, !dbg !54
  call void @disable_isr(i32 1) #3, !dbg !55
...
40:                                               ; preds = %38, %35, %32
  call void @enable_isr(i32 1) #3, !dbg !64
  ret void, !dbg !65
}
...
declare dso_local void @idlerun(...) #2

declare dso_local void @disable_isr(i32) #2

declare dso_local void @enable_isr(i32) #2

; Function Attrs: argmemonly nounwind
declare void @llvm.lifetime.end.p0i8(i64 immarg, i8* nocapture) #1

; Function Attrs: nounwind uwtable
define dso_local void @svp_simple_019_001_isr_1() #0 !dbg !66 {
  call void (...) @idlerun() #3, !dbg !67
...
!1 = !DIFile(filename: "svp_simple_019_001.c", directory: "/home/jack-zhou/Documents/llvm-exp/nasac2019-race-detection-competition/DRace1/test/svp_simple_019")
!2 = !{}
...
!8 = !DIFile(filename: "./svp_simple_019_001.c", directory: "/home/jack-zhou/Documents/llvm-exp/nasac2019-race-detection-competition/DRace1/test/svp_simple_019")
