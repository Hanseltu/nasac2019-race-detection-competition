...
define void @svp_simple_026_001_isr_1() #0 !dbg !28 {
  %1 = load volatile i32, i32* @svp_simple_026_001_gloable_var, align 4, !dbg !29, !tbaa !14
  %2 = add nsw i32 %1, 1, !dbg !29
  store volatile i32 %2, i32* @svp_simple_026_001_gloable_var, align 4, !dbg !29, !tbaa !14
  ret void, !dbg !30
}
...
!29 = !DILocation(line: 40, column: 33, scope: !28)
