...
define void @svp_simple_009_001_isr_1() #0 !dbg !34 {
  ...
  %2 = load i32*, i32** @svp_simple_009_001_p, align 8, !dbg !36, !tbaa !21
  %3 = load volatile i32, i32* %2, align 4, !dbg !37, !tbaa !14
  %4 = bitcast i32* %1 to i8*, !dbg !38
  call void @llvm.lifetime.start.p0i8(i64 4, i8* %4) #3, !dbg !38
  store i32 8, i32* %1, align 4, !dbg !39, !tbaa !14
  store i32* %1, i32** @svp_simple_009_001_m, align 8, !dbg !40, !tbaa !21
  %5 = load i32*, i32** @svp_simple_009_001_m, align 8, !dbg !41, !tbaa !21
  %6 = load volatile i32, i32* %5, align 4, !dbg !42, !tbaa !14
  %7 = bitcast i32* %1 to i8*, !dbg !43
  call void @llvm.lifetime.end.p0i8(i64 4, i8* %7) #3, !dbg !43
  ret void, !dbg !43
}
...
!9 = !DIFile(filename: "./svp_simple_009_001.c", directory: "/Users/tuhaoxin/github/nasac2019-race-detection-competition/llvm-api-demo/c-src/2.1/svp_simple_009")
...
!36 = !DILocation(line: 44, column: 14, scope: !34)
!37 = !DILocation(line: 44, column: 13, scope: !34)
!38 = !DILocation(line: 45, column: 3, scope: !34)
!39 = !DILocation(line: 45, column: 7, scope: !34)
!40 = !DILocation(line: 46, column: 24, scope: !34)
!41 = !DILocation(line: 47, column: 14, scope: !34)
!42 = !DILocation(line: 47, column: 13, scope: !34)
!43 = !DILocation(line: 48, column: 1, scope: !34)
