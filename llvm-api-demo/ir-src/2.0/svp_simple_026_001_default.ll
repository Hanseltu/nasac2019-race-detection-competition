...
; <label>:4:                                      ; preds = %3, %0
  call void @enable_isr(i32 1), !dbg !16
  ret i32 0, !dbg !17
}
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @svp_simple_026_001_init() #0 !dbg !18 {
  %1 = call i32 (...) @rand(), !dbg !19
  store volatile i32 %1, i32* @svp_simple_026_001_gloable_var, align 4, !dbg !20
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define void @svp_simple_026_001_isr_1() #0 !dbg !23 {
  %1 = load volatile i32, i32* @svp_simple_026_001_gloable_var, align 4, !dbg !24
  %2 = add nsw i32 %1, 1, !dbg !24
  store volatile i32 %2, i32* @svp_simple_026_001_gloable_var, align 4, !dbg !24
  ret void, !dbg !25
}

; Function Attrs: noinline nounwind optnone ssp uwtable
define void @svp_simple_026_001_isr_2() #0 !dbg !26 {
  %1 = load volatile i32, i32* @svp_simple_026_001_gloable_var, align 4, !dbg !27
  %2 = add nsw i32 %1, -1, !dbg !27
  store volatile i32 %2, i32* @svp_simple_026_001_gloable_var, align 4, !dbg !27
  ret void, !dbg !28
}
...
!18 = distinct !DISubprogram(name: "svp_simple_026_001_init", scope: !1, file: !1, line: 33, type: !9, isLocal: false, isDefinition: true, scopeLine: 33, isOptimized: false, unit: !0, retainedNodes: !2)
!19 = !DILocation(line: 34, column: 36, scope: !18)
!20 = !DILocation(line: 34, column: 34, scope: !18)
!21 = !DILocation(line: 36, column: 3, scope: !18)
!22 = !DILocation(line: 37, column: 1, scope: !18)
!23 = distinct !DISubprogram(name: "svp_simple_026_001_isr_1", scope: !1, file: !1, line: 39, type: !9, isLocal: false, isDefinition: true, scopeLine: 39, isOptimized: false, unit: !0, retainedNodes: !2)
!24 = !DILocation(line: 40, column: 33, scope: !23)
!25 = !DILocation(line: 41, column: 1, scope: !23)
!26 = distinct !DISubprogram(name: "svp_simple_026_001_isr_2", scope: !1, file: !1, line: 42, type: !9, isLocal: false, isDefinition: true, scopeLine: 42, isOptimized: false, unit: !0, retainedNodes: !2)
!27 = !DILocation(line: 43, column: 33, scope: !26)
!28 = !DILocation(line: 44, column: 1, scope: !26)
