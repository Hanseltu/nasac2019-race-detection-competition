...
define void @svp_simple_013_001_main() #0 !dbg !8 {
  ...
  store i32 0, i32* %5, align 4, !dbg !13
  br label %6, !dbg !14

; <label>:6:                                      ; preds = %15, %0
  %7 = load i32, i32* %5, align 4, !dbg !15
  %8 = icmp slt i32 %7, 100, !dbg !16
  br i1 %8, label %9, label %18, !dbg !17

; <label>:9:                                      ; preds = %6
  %10 = load i32, i32* %5, align 4, !dbg !18
  %11 = icmp eq i32 %10, 99, !dbg !19
  br i1 %11, label %12, label %14, !dbg !18

; <label>:12:                                     ; preds = %9
  %13 = load volatile i32, i32* @svp_simple_013_001_global_var1, align 4, !dbg !20
...
; <label>:15:                                     ; preds = %14
  %16 = load i32, i32* %5, align 4, !dbg !24
  %17 = add nsw i32 %16, 1, !dbg !24
  store i32 %17, i32* %5, align 4, !dbg !24
  br label %6, !dbg !17, !llvm.loop !25

; <label>:18:                                     ; preds = %6
  %19 = load volatile i32, i32* @svp_simple_013_001_global_var1, align 4, !dbg !26
  store i32 %19, i32* %2, align 4, !dbg !27
  %20 = load volatile i32, i32* @svp_simple_013_001_global_var2, align 4, !dbg !28
  store i32 %20, i32* %3, align 4, !dbg !29
  %21 = load volatile i32, i32* @svp_simple_013_001_global_var2, align 4, !dbg !30
  store i32 %21, i32* %4, align 4, !dbg !31
  ret void, !dbg !32
}
...
define void @svp_simple_013_001_isr_2() #0 !dbg !38 {
  ...
  store i32 1, i32* @svp_simple_013_001_global_flag1, align 4, !dbg !40
  store i32 0, i32* @svp_simple_013_001_global_flag2, align 4, !dbg !41
...
define void @svp_simple_013_001_isr_3() #0 !dbg !45 {
  %1 = load i32, i32* @svp_simple_013_001_global_flag1, align 4, !dbg !46
  %2 = icmp eq i32 %1, 1, !dbg !47
  br i1 %2, label %3, label %4, !dbg !46

; <label>:3:                                      ; preds = %0
  store volatile i32 1, i32* @svp_simple_013_001_global_var1, align 4, !dbg !48
  br label %4, !dbg !49

; <label>:4:                                      ; preds = %3, %0
  %5 = load i32, i32* @svp_simple_013_001_global_flag2, align 4, !dbg !50
  %6 = icmp eq i32 %5, 1, !dbg !51
  br i1 %6, label %7, label %8, !dbg !50

; <label>:7:                                      ; preds = %4
  store volatile i32 1, i32* @svp_simple_013_001_global_var2, align 4, !dbg !52
  br label %8, !dbg !53
...
!13 = !DILocation(line: 38, column: 12, scope: !8)
!14 = !DILocation(line: 38, column: 8, scope: !8)
!15 = !DILocation(line: 38, column: 19, scope: !8)
!16 = !DILocation(line: 38, column: 21, scope: !8)
!17 = !DILocation(line: 38, column: 3, scope: !8)
!18 = !DILocation(line: 39, column: 9, scope: !8)
!19 = !DILocation(line: 39, column: 11, scope: !8)
!20 = !DILocation(line: 39, column: 33, scope: !8)
!21 = !DILocation(line: 39, column: 31, scope: !8)
!22 = !DILocation(line: 39, column: 23, scope: !8)
!23 = !DILocation(line: 39, column: 14, scope: !8)
!24 = !DILocation(line: 38, column: 36, scope: !8)
!25 = distinct !{!25, !17, !20}
!26 = !DILocation(line: 41, column: 13, scope: !8)
!27 = !DILocation(line: 41, column: 11, scope: !8)
!28 = !DILocation(line: 43, column: 13, scope: !8)
!29 = !DILocation(line: 43, column: 11, scope: !8)
!30 = !DILocation(line: 45, column: 13, scope: !8)
!31 = !DILocation(line: 45, column: 11, scope: !8)
!32 = !DILocation(line: 46, column: 1, scope: !8)
!33 = distinct !DISubprogram(name: "svp_simple_013_001_isr_1", scope: !1, file: !1, line: 48, type: !9, isLocal: false, isDefinition: true, scopeLine: 48, isOptimized: false, unit: !0, retainedNodes: !2)
...
!38 = distinct !DISubprogram(name: "svp_simple_013_001_isr_2", scope: !1, file: !1, line: 54, type: !9, isLocal: false, isDefinition: true, scopeLine: 54, isOptimized: false, unit: !0, retainedNodes: !2)
...
!45 = distinct !DISubprogram(name: "svp_simple_013_001_isr_3", scope: !1, file: !1, line: 64, type: !9, isLocal: false, isDefinition: true, scopeLine: 64, isOptimized: false, unit: !0, retainedNodes: !2)
