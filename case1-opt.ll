...
define void @case1_main() local_unnamed_addr #0 {
  %1 = load volatile i8, i8* @shared1_uchar, align 1, !tbaa !3
  %2 = icmp eq i8 %1, 0
  br i1 %2, label %5, label %3

; <label>:3:                                      ; preds = %0
  %4 = load volatile i8, i8* @shared1_uchar, align 1, !tbaa !3
  br label %5
...
define void @case1_isr() local_unnamed_addr #1 {
  tail call void (...) @idlerun() #3
  store volatile i8 1, i8* @shared1_uchar, align 1, !tbaa !3
  tail call void (...) @idlerun() #3
  ret void
}
